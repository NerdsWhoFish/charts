...
Helm charts for [FetchHQ](https://github.com/FetchHQ) projects.
...
| Chart | Installs |
| --- | --- |
| [dusk](dusk/) | [Dusk](https://github.com/FetchHQ/dusk), a service catalog that maintains itself |

## Install

```bash
helm install dusk oci://ghcr.io/fetchhq/charts/dusk \
...
See [ADR-0019](https://github.com/FetchHQ/dusk/blob/main/adr/0019-chart-repo.md).
